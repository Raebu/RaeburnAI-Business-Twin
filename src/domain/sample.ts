...
export const sampleTwin: BusinessTwin = {
  ...
  workflows: [
    {
      ...
      ownerTeamId: 'delivery',
      weeklyVolume: 600,
      minutesPerUnit: 8,
      requiredRoleIds: ['role-rec'],
      toolNames: ['LinkedIn', 'ATS'],
    ...
    },
    {
      ...
      ownerTeamId: 'operations',
      weeklyVolume: 35,
      minutesPerUnit: 45,
      requiredRoleIds: ['role-ops', 'role-am'],
      toolNames: ['Sheets', 'CRM'],
  ...
  kpis: [
    {
      id: 'kpi-fill',
      name: 'Average time to shortlist',
      ownerTeamId: 'delivery',
      current: 5.2,
      target: 4,
      unit: 'days',
